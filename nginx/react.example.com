server {
  ...
  server_name react.example.com www.react.example.com;
  server_tokens off;
  ...
  if ($https_redirect = 1) { return 301 https://react.example.com$request_uri; }
  ...
  location / {
    ...
    root /home/ontid/react/build; # EXAMPLE
